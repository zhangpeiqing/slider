...
touchSensitivity:5,normalScrollElementTouchThreshold:5,keyboardScrolling:!0,animateAnchor:!0,recordHistory:!0,controlArrows:!0,controlArrowColor:"#fff",verticalCentered:!0,resize:!0,sectionsColor:[],paddingTop:0,paddingBottom:0,fixedElements:null,responsive:0,sectionSelector:".section",slideSelector:".slide",
    ...
    scrollingSpeed:10,
    resize:true,
	afterRender:function(timer){
         $('.section1').find('.pg1').addClass('active');
         $('.section1').find('.h1').addClass('active');
         $('.section1').find('.fh_txt').addClass('active');
         $('.section1').find('.pg1_t').addClass('active');
         $('.section1').find('.lastli').addClass('active');
    },afterLoad: function(anchorLink, index,timer){
        if(index==1){
           $('.section1').find('.pg1').addClass('active');
           $('.section1').find('.h1').addClass('active');
           $('.section1').find('.fh_txt').addClass('active');
        ...
        if(index==2){
           $('.section2').find('.er_1').addClass('active');
           $('.section2').find('.swiper-container_C').addClass('active');
        }
        if(index==3){
           $('.section3').find('.er_2').addClass('active');
           $('.section3').find('.form').addClass('active');
        }
        if(index==4){
           $('.section4').find('.er_3').addClass('active');
           $('.section4').find('.er_4').addClass('active');
           $('.section4').find('.er_5').addClass('active');
        }
        if(index==5){
           $('.section5').find('.t5').addClass('active');
           $('.section5').find('.sec5').addClass('active');
        }
        if(index==6){
           $('.section6').find('.t6').addClass('active');
           $('.section6').find('.sec6').addClass('active');
        }
    },onLeave:function(index, direction,timer){
        if(index==1){
            $('.section1').find('.pg1').removeClass('active');
            $('.section1').find('.h1').removeClass('active');
            $('.section1').find('.fh_txt').removeClass('active');
            $('.section1').find('.pg1_t').removeClass('active');
            $('.section1').find('.lastli').removeClass('active');
        }
        if(index==2){
           $('.section2').find('.er_1').removeClass('active');
           $('.section2').find('.swiper-container_C').removeClass('active');
        }
        if(index==3){
           $('.section3').find('.er_2').removeClass('active');
           $('.section3').find('.form').removeClass('active');
        }
        if(index==4){
           $('.section4').find('.er_3').removeClass('active');
           $('.section4').find('.er_4').removeClass('active');
           $('.section4').find('.er_5').removeClass('active');
        }
        if(index==5){
           $('.section5').find('.t5').removeClass('active');
           $('.section5').find('.sec5').removeClass('active');
        }
        if(index==6){
           $('.section6').find('.t6').removeClass('active');
           $('.section6').find('.sec6').removeClass('active');
        }
    },afterResize:null,afterReBuild:null,afterSlideLoad:null,onSlideLeave:null},c);(function(){c.continuousVertical&&(c.loopTop||c.loopBottom)&&(c.continuousVertical=
